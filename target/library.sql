...
CREATE TABLE `borrowing_record` (
  ...
  CONSTRAINT `borrowing_record_ibfk_1` FOREIGN KEY (`User_Id`) REFERENCES `user` (`User_Id`),
  CONSTRAINT `borrowing_record_ibfk_2` FOREIGN KEY (`Inventory_Id`) REFERENCES `inventory` (`Inventory_Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2024-03-30 22:41:41
